...
2) At first page, you should convert current product's price to formatted price string, including the currency symbol and commas (e.g., "$2,999").
3) At first page, you should convert products' arrangement style 4 X 3 to 3 X 4.
4) At product detail page, you should display "Buy now" text at button which is next to "Add to OrderList" button.
